...
4. **目标共识**：毛利额是核心经营目标；销售额、毛利率、广告效率、库存周转、评分/退款等都是支撑毛利额达成的 KR，不要把销售额增长等同于经营成功。
...
export const ChatBot: React.FC<ChatBotProps> = ({ data, inventory, refunds, filters, rawPerformance, rawInventory }) => {
    ...
    const QUICK_QUESTIONS = [
        { label: '诊断大盘', question: '请对当前筛选条件下的整体表现做全面诊断：以毛利额为核心目标，销量、销售额、毛利率、广告效率、库存和口碑这些 KR 各自与目标的差距有多大？最大的风险点是什么？' },
        ...
        { label: '负责人总结', question: '按负责人维度汇总核心数据（毛利额、销售额、毛利率、广告占比），围绕毛利额核心目标找出各自亮点和需要关注的问题。' },
    ];
